...
package Rival::WWW::Mechanize::Cached::Multiple;
$Rival::WWW::Mechanize::Cached::Multiple::VERSION = '1.44';
use 5.006;
  ...
  if ( !$cache ) {
    ...
    if ( eval { require CHI; 1 } ) {
      ...
      croak("Could not create a default cache." .
            "Please make sure CHI is installed or configure manually as appropriate"
	   );
    }
  }
...
sub _make_request {
  ...
  # FIXME: make this able to cache multiple files from different
  # dates, only caching if it is different than the immediately
  # previous version in the cache, i.e. like archive.org's
  # waybackmachine
...
Rival::WWW::Mechanize::Cached::Multiple - Cache response to be polite
...
=head1 SYNOPSIS
    ...
    my $mech = Rival::WWW::Mechanize::Cached::Multiple->new( cache => $cache );
...
The default Cache object is set up with the following params:
    ...
    my $cache_params = {
        default_expires_in => "1d", namespace => 'rival-www-mechanize-cached-special',
    };
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Rival::WWW::Mechanize::Cached::Multiple

=over

=item * Search CPAN

L<https://metacpan.org/module/Rival::WWW::Mechanize::Cached::Multiple>

=back

=head1 SEE ALSO

L<WWW::Mechanize>, L<WWW::Mechanize::Cached>, L<Rival::WWW::Mechanize::Cached::Multiple>.
