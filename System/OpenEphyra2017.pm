...
sub StartServer {
  my ($self,%args) = @_;
  chdir "/var/lib/myfrdcsa/sandbox/openephyra-20170320/openephyra-20170320/scripts/";
  my $command = "./OpenEphyra.sh";
  # my $command = "/var/lib/myfrdcsa/codebases/internal/perllib/System/OpenEphyra2017/sim.pl";
  my @parameters;
